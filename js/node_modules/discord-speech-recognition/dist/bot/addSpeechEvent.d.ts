 ...
 * ```
 */
export declare const addSpeechEvent: <T extends SpeechRecognition = typeof resolveSpeechWithGoogleSpeechV2>(client: Client, options?: SpeechOptions<T> | undefined) => void;
